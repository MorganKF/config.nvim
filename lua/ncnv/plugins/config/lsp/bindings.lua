...
function M.on_attach(client, buffer)
    ...
    local format = require('ncnv.plugins.config.lsp.format').format

    self:map(
        '<leader>ctf',
        require('ncnv.plugins.config.lsp.format').toggle,
        { desc = 'Toggle format on save', has = 'documentFormatting' }
    )
